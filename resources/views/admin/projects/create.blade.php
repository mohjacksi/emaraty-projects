    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('operating_permission_date') ? 'is-invalid' : '' }}" type="text" name="operating_permission_date" id="operating_permission_date" value="{{ old('operating_permission_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_order') ? 'is-invalid' : '' }}" type="text" name="purchase_order" id="purchase_order" value="{{ old('purchase_order', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_purchase') ? 'is-invalid' : '' }}" type="text" name="date_of_purchase" id="date_of_purchase" value="{{ old('date_of_purchase') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_delivery') ? 'is-invalid' : '' }}" type="text" name="date_of_delivery" id="date_of_delivery" value="{{ old('date_of_delivery') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_commencement') ? 'is-invalid' : '' }}" type="text" name="date_of_commencement" id="date_of_commencement" value="{{ old('date_of_commencement') }}">
            ...
            <div class="form-group">
                <label for="date_of_reference">{{ trans('cruds.project.fields.date_of_reference') }}</label>
                <input class="form-control date {{ $errors->has('date_of_reference') ? 'is-invalid' : '' }}" type="text" name="date_of_reference" id="date_of_reference" value="{{ old('date_of_reference') }}">
                @if($errors->has('date_of_reference'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date_of_reference') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.date_of_reference_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="project_duration">{{ trans('cruds.project.fields.project_duration') }}</label>
                <input class="form-control {{ $errors->has('project_duration') ? 'is-invalid' : '' }}" type="number" name="project_duration" id="project_duration" value="{{ old('project_duration', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('assumed_date_of_receipt') ? 'is-invalid' : '' }}" type="text" name="assumed_date_of_receipt" id="assumed_date_of_receipt" value="{{ old('assumed_date_of_receipt') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('samples_approval') ? 'is-invalid' : '' }}" name="samples_approval" id="samples_approval">
                    ...
                    @foreach(App\Project::SAMPLES_APPROVAL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('samples_approval', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('completion_rate') ? 'is-invalid' : '' }}" type="number" name="completion_rate" id="completion_rate" value="{{ old('completion_rate', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('current_batch_number') ? 'is-invalid' : '' }}" name="current_batch_number" id="current_batch_number">
                    ...
                    @foreach(App\Project::CURRENT_BATCH_NUMBER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('current_batch_number', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_payment_value') ? 'is-invalid' : '' }}" type="number" name="current_payment_value" id="current_payment_value" value="{{ old('current_payment_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('initial_receipt_date') ? 'is-invalid' : '' }}" type="text" name="initial_receipt_date" id="initial_receipt_date" value="{{ old('initial_receipt_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_receipt_project') ? 'is-invalid' : '' }}" type="text" name="date_of_receipt_project" id="date_of_receipt_project" value="{{ old('date_of_receipt_project') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('final_receipt_date') ? 'is-invalid' : '' }}" type="text" name="final_receipt_date" id="final_receipt_date" value="{{ old('final_receipt_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('final_completion_percentage') ? 'is-invalid' : '' }}" type="number" name="final_completion_percentage" id="final_completion_percentage" value="{{ old('final_completion_percentage', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delay_days') ? 'is-invalid' : '' }}" type="number" name="delay_days" id="delay_days" value="{{ old('delay_days', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('justify_delay') ? 'is-invalid' : '' }}" name="justify_delay" id="justify_delay">{{ old('justify_delay') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_done') ? 'is-invalid' : '' }}" type="number" name="work_done" id="work_done" value="{{ old('work_done', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_bef_end') ? 'is-invalid' : '' }}" type="number" name="pay_bef_end" id="pay_bef_end" value="{{ old('pay_bef_end', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reserved_rate') ? 'is-invalid' : '' }}" type="text" name="reserved_rate" id="reserved_rate" value="{{ old('reserved_rate', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('warranty') ? 'is-invalid' : '' }}" type="number" name="warranty" id="warranty" value="{{ old('warranty', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('final_payment') ? 'is-invalid' : '' }}" type="number" name="final_payment" id="final_payment" value="{{ old('final_payment', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('project_state') ? 'is-invalid' : '' }}" name="project_state" id="project_state">
                    ...
                    @foreach(App\Project::PROJECT_STATE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('project_state', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('delivery_recipient') ? 'is-invalid' : '' }}" name="delivery_recipient" id="delivery_recipient">
                    ...
                    @foreach(App\Project::DELIVERY_RECIPIENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('delivery_recipient', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
